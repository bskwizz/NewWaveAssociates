...
interface DataInsightsCaseStudyProps {
  onNavigate: (page: string) => void;
}

export default function DataInsightsCaseStudy({ onNavigate }: DataInsightsCaseStudyProps) {
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    ...
                    <span>Leadership team reviewing 40+ metrics weekly with no clear prioritization</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Three different definitions of "active customer" across departments</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Ad hoc analysis taking precedence over strategic insights</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Data scattered across multiple systems with no single source of truth</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Analysts spending 70% of time on data wrangling vs. generating insights</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div id="approach" className="mb-16 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span><strong>Strategy Alignment (Weeks 1-2):</strong> Facilitated executive workshops to clarify strategic priorities, identified critical business questions that metrics should answer, and mapped existing metrics to strategic objectives.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span><strong>Metric Design (Weeks 3-6):</strong> Defined "vital few" KPIs for Board, executive team, and functional leaders, created metric dictionary with clear definitions and ownership, designed leading and lagging indicator framework, and established thresholds for escalation and action.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span><strong>Data Infrastructure (Weeks 7-12):</strong> Built centralized data warehouse as single source of truth, automated data pipelines to reduce manual work, created self-service dashboards for different stakeholder levels, and implemented data governance protocols.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span><strong>Cadence & Culture (Weeks 13-16):</strong> Redesigned meeting structures around KPI review and action planning, trained leaders on how to use data to drive decisions, established monthly business review rhythm, and created continuous improvement feedback loop.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div id="outcome" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                <ul className="space-y-3 ml-6 mb-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Leadership team reduced metrics reviewed from 40+ to 12 core KPIs</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Meeting time spent on data clarification decreased by 75%</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Analytics team shifted from 70% data prep to 70% insight generation</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Decision velocity improved as executives had confidence in data accuracy</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Board meetings now focused on strategic discussion vs. metric clarification</span>
                  </li>
                </ul>
                <p>
