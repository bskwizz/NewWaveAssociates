              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    ...
                    <span>Manual collections and fragmented dispute management</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Long DSO and high cost-to-collect</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Lack of credit visibility and forecasting</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Inefficient reconciliation across entities</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div id="approach" className="mb-16 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Deployed intelligent collections prioritization and automated reminders</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Centralized dispute tracking with real-time collaboration</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Automated cash application through remittance matching</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Integrated credit-risk analytics and performance reporting</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div id="outcome" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>DSO reduced 5–15 days</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Cost-to-collect lowered 40%–60%</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>FTE efficiency ≈ 50% gain</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Payback 6–9 months | 3-year ROI 300%–500%</span>
                  </li>
                </ul>
              </div>
            </div>
