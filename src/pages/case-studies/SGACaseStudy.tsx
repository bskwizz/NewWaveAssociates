...
interface SGACaseStudyProps {
  onNavigate: (page: string) => void;
}

export default function SGACaseStudy({ onNavigate }: SGACaseStudyProps) {
            ...
            <div>
              ...
              <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-8 mb-8 shadow-lg max-w-4xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  [Placeholder content for SG&A Cost Optimization case study executive summary. This will be replaced with actual case study details about how New Wave Associates helped a company rationalize SG&A costs, optimize support functions, and drive EBITDA expansion without sacrificing growth capabilities.]
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-12 mb-12">
            <div id="opportunity" className="mb-16 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <p>
                  [Placeholder content describing the client's SG&A cost challenges and margin pressure.]
                </p>
                <p>
            ...
            <div id="approach" className="mb-16 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <p>
                  New Wave Associates implemented a targeted SG&A optimization program:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
