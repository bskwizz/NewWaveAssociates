          ...
          Back to SG&A Cost Optimization
            ...
            <div>
              <h1 className="text-5xl font-bold text-[#38495D] mb-4">
                Virtual Card Solution Implementation
              </h1>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    ...
                    <span>Dispersed payment methods with no rebate capture or tracking</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Manual AP workflows and limited visibility into supplier adoption</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Opportunity to monetize card payments and improve cash management</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div id="approach" className="mb-16 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Evaluated multiple issuing banks and selected preferred VC partner</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Designed a phased rollout covering supplier segmentation, enrollment, and enablement</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Integrated VC payments into the ERP and procurement ecosystem</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Established KPIs for adoption, rebate yield, and cycle-time reduction</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Delivered executive dashboards to monitor supplier participation and realized value</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div id="outcome" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Achieved $4.5M annual rebate value within first 12 months</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Reduced AP cycle time by 35% through automation and digital processing</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Improved working-capital position and supplier transparency</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-[#01A3DB] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Institutionalized VC program as enterprise standard for future acquisitions</span>
                  </li>
                </ul>
              </div>
            </div>
