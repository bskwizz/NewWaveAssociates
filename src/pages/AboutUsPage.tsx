  ...
  return (
    <div>
      <div ref={vantaRef} className="capabilities-hero relative" aria-label="About Us">
        ...
        <div className="absolute top-[48px] sm:top-[56px] left-0 right-0 w-full pointer-events-none z-30 lg:top-[256px] lg:-translate-y-1/2">
          <img
        ...
        <div className="capabilities-hero__inner hero-content relative z-20 pt-[64px] sm:pt-[80px] lg:pt-[4rem]">
