...
export default function CapabilitiesPage({ onNavigate }: CapabilitiesPageProps) {
  ...
  return (
    <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                <div className="text-left">
                  <div className="inline-block mb-2">
                    <div>
                      <p className="text-black text-xs sm:text-sm md:text-base font-bold uppercase mb-2" style={{
                        letterSpacing: '0.2em'
                      }}>
                        OUR EXPERIENCE
                      </p>
                ...
                <div className="overflow-x-auto px-2 sm:px-0">
                  <div className="inline-block min-w-full align-middle">
                    <div className="overflow-hidden shadow-2xl rounded-lg">
                      <table className="min-w-full border-collapse bg-white" style={{ maxWidth: '100%' }}>
                        <thead>
                          <tr className="bg-[#00a4dd]">
                            <th className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-left text-white font-semibold text-xs sm:text-sm uppercase tracking-tight sm:tracking-wider whitespace-nowrap">Industry</th>
                            <th className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-left text-white font-semibold text-xs sm:text-sm uppercase tracking-tight sm:tracking-wider whitespace-nowrap">Role</th>
                            <th className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-left text-white font-semibold text-xs sm:text-sm uppercase tracking-tight sm:tracking-wider whitespace-nowrap">Duration</th>
                            <th className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-left text-white font-semibold text-xs sm:text-sm uppercase tracking-tight sm:tracking-wider">Outcomes</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                            <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Technology and Managed Service Providers</td>
                            <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Vice President of Strategy and Transformation</td>
                            <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700 whitespace-nowrap">3 Months</td>
                            <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Technology and Managed Service Providers</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Director of Transformation</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">8 Months</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Technology and Managed Service Providers</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Chief Growth Officer</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">8 Months</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">B2B SaaS / FinTech</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Vice President of Revenue Operations</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">2.5 Years</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">B2B SaaS / FinTech / AI</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Chief Operating Officer</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">1 Year</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">B2B SaaS / Fintech</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Director Strategy</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">2 Years</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Healthcare</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Sr. Director of Strategic Sourcing</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">2 Years</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Waste & Recycling Services</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">VP of Strategic Sourcing</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">1 Year</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">BPO / ARM</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">Chief Procurement Officer</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">3 Years</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
                      ...
                      <tr className="hover:bg-gray-50 transition-colors">
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">B2B / B2C Banking Payments</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">VP of Strategic Alliance</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">1 Year</td>
                        <td className="px-2 sm:px-4 md:px-6 py-2 md:py-4 text-xs sm:text-sm text-gray-700">
                          <ul className="list-disc list-inside space-y-1">
      ...
      <div className="bg-gray-50 pt-12 md:pt-16 pb-12 md:pb-16">
            ...
            >
              ...
              <div className="space-y-3 md:space-y-4">
                <ul className="space-y-2 md:space-y-3">
                  {capability.points.map((point, i) => (
                    <li key={i} className="flex items-start gap-2 md:gap-3 text-sm sm:text-base text-gray-700">
                      <span className="text-[#01A3DB] mt-1 flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
                <div className="pt-3 md:pt-4 border-t border-gray-200 space-y-3 md:space-y-4">
                  <div>
                    <p className="text-xs sm:text-sm font-semibold text-[#EF5919] mb-1">
                      Outcome:
                    </p>
                    <p className="text-sm sm:text-base text-gray-700 italic">{capability.outcome}</p>
                  </div>
                  <div>
                    <p className="text-xs sm:text-sm font-semibold text-[#38495D] mb-2">
                      Related Case Studies:
                    </p>
                    {capability.caseStudyRoute ? (
                      <button
                        onClick={() => onNavigate(capability.caseStudyRoute!)}
                        className="text-[#01A3DB] hover:text-[#0182b3] underline text-xs sm:text-sm transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="inline-block px-3 sm:px-4 py-2 bg-gray-100 text-[#38495D] rounded hover:bg-gray-200 text-xs sm:text-sm transition-colors"
                      >
