    ...
    <div>
      <div id="our-services-hero" ref={vantaRef} className="flywheel-hero fw-glow flex flex-col min-h-[100svh] overflow-hidden lg:overflow-visible lg:min-h-screen" aria-label="New Wave Flywheel" style={{ position: 'relative' }}>
        ...
        <div className="relative z-10 flex-1 flex flex-col">
          ...
          <div className="relative flex items-start flex-1 pt-8 pb-4 sm:pt-12 sm:pb-6 lg:pt-16 lg:pb-0 lg:min-h-0">
        ...
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-[1] flex justify-center lg:translate-y-[calc(15%+184px)]">
          <img
