  ...
  return (
    <div>
      <div id="our-services-hero" ref={vantaRef} className="flywheel-hero fw-glow" aria-label="New Wave Flywheel" style={{ minHeight: '100vh', position: 'relative' }}>
        ...
        <div className="absolute inset-x-0 bottom-0 lg:-bottom-32 mt-20 translate-y-16 lg:mt-0 lg:-translate-y-12 max-h-[300px] h-[30vh] lg:max-h-[600px] lg:h-[60vh] pointer-events-none">
          <img
