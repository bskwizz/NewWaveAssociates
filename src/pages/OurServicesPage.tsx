  ...
  return (
    <div>
      <div id="our-services-hero" ref={vantaRef} className="flywheel-hero fw-glow" aria-label="New Wave Flywheel" style={{ minHeight: '100vh', position: 'relative', overflow: 'visible', paddingBottom: '200px' }}>
        ...
        <div className="absolute inset-x-0 bottom-0 lg:bottom-12 mt-20 translate-y-16 lg:mt-0 lg:translate-y-0 max-h-[300px] h-[30vh] lg:max-h-[800px] lg:h-[80vh] pointer-events-none z-10">
          <img
