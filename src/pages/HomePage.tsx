    ...
    <div className="overflow-x-clip">
      ...
      <Section background="gray">
        <SectionHeader
          ...
          intro="Access experienced fractional and interim leaders with a proven track record of success. Whether you need experienced leadership for a critical function, an operator to lead a transformation, or temporary leadership while you hire, New Wave provides the leadership you need to keep your business moving forward. Our expertise spans the critical business functions where experienced leadership creates the greatest impact."
        />
